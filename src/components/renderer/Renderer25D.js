    ...
    if (icon) {
        ...
        const FacebookIcon = (
            <g>
                ...
                <path
                    d="M 69 100 L 69 61.273438 L 81.996094 61.273438 L 83.941406 46.183594 L 68.996094 46.183594 L 68.996094 36.546875 C 68.996094 32.175781 70.210938 29.199219 76.476562 29.199219 L 84.46875 29.195312 L 84.46875 15.699219 C 83.085938 15.515625 78.34375 15.101562 72.824219 15.101562 C 61.300781 15.101562 53.414062 22.136719 53.414062 35.054688 L 53.414062 46.183594 L 40.382812 46.183594 L 40.382812 61.273438 L 53.414062 61.273438 L 53.414062 100 Z M 69 100 "
                    fill="#fff"/>
            </g>
        )
        const InstagramIcon = (
        ...
        if (icon && iconMode) {
            ...
            pointList.push(
                <g transform={matrixString}>
                    <path d={sq25} stroke="#FFF" strokeWidth={100 / iconSize * 1} fill="#FFF"
                          transform={'translate(' + String(iconXY) + ',' + String(iconXY) + ') ' + 'scale(' + String(iconSize / 100) + ',' + String(iconSize / 100) + ')'}/>
                </g>
            );
            pointList.push(
                <g key={id++} transform={matrixString}>
                    <defs>
                        <path id={"defs-path" + randomIdDefs} d={sq25} fill="#FFF"
                              transform={'translate(' + String(iconXY) + ',' + String(iconXY) + ') ' + 'scale(' + String(iconSize / 100) + ',' + String(iconSize / 100) + ')'}/>
                    </defs>
                    <clipPath id={"clip-path" + randomIdClips}>
                        <use xlinkHref={"#defs-path" + randomIdDefs}  overflow="visible"/>
